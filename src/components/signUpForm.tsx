...
const SignUpForm = () => {
    ...
    const [isDetails, setDetails] = useState<User>({username: '', profilePicture: '', password: ''})
        ...
        <div className='flex flex-col justify-center bg-base-100 w-full'>
            ...
            <div className='flex gap-2'>
                <div className='flex flex-col form-control'>
                    <input type="text" id="username" name="username" className='form-input input input-bordered' placeholder='Username' required/>
                </div>
